...
export default function Policy() {
  ...
  return (
    <Card className="lg:my-8 lg:w-3/5">
      ...
      <br />
      <p>
        Assignmint operates the https://www.assignmint.tech/ website, which
      ...
      <p>
        ...
        decided to use our Service, the Assignmint website.
      </p>
      <br />
      <p>
      ...
      <p>
        ...
        https://www.assignmint.tech/, unless otherwise defined in this Privacy
        Policy.
      </p>
      <br />
      ...
      <p>
        ...
        information that we collect will be used to contact or identify you. The
        types of information we collect include, but are not limited to:
      </p>
      <ul>
        <li>First Name</li>
        <li>Last Name</li>
      ...
      <h2 className={sectionHeaderStyle}>Cookies</h2>
      <p>
      ...
      <br />
      <p>
        Our website uses these &quotcookies&quot to collection information and
      ...
      <h2 className={sectionHeaderStyle}>Service Providers</h2>
      <p>
      ...
      <h2 className={sectionHeaderStyle}>Links to Other Sites</h2>
      <p>
