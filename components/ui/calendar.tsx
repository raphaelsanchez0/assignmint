  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        month: "space-y-4",
        caption: "flex justify-center align-center pt-1 relative items-center",
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 sm:font-normal font-large aria-selected:opacity-100",
        ),
        ...
        day_today: "bg-primary text-white dark:bg-primary dark:text-slate-50",
        day_outside:
